...
const integrationSettingsSchema = new Schema(
  {
    ...
    quickbooks: {
      ...
      lastPullStatus: { type: String, enum: ['idle', 'running', 'success', 'error'], default: 'idle' },
      lastPullAt: { type: Date, default: null },
      lastPullCount: { type: Number, default: 0 },
      lastPullError: { type: String, default: null },
      lastPushStatus: { type: String, enum: ['idle', 'running', 'success', 'error'], default: 'idle' },
