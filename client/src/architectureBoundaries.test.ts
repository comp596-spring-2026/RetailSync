...
const allowedCrossModuleImports = [
  ...
  'modules/accounting/pages/QuickBooksSyncPage.tsx:22 imports "../../settings/components" -> modules/settings/components',
  ...
  'modules/quickbooks/QuickBooksDashboard.tsx:21 imports "../accounting/api" -> modules/accounting/api',
  'modules/quickbooks/components/RequireQuickBooksConnection.tsx:7 imports "../../accounting/api" -> modules/accounting/api',
  ...
  'modules/quickbooks/pages/Contacts.tsx:33 imports "../../accounting/api" -> modules/accounting/api',
  ...
  'modules/users/components/EditMemberModal.tsx:15 imports "../../rbac/state/rbacSlice" -> modules/rbac/state/rbacSlice',
  'modules/users/components/InviteMemberModal.tsx:14 imports "../../rbac/state/rbacSlice" -> modules/rbac/state/rbacSlice',
  'modules/users/pages/UsersPage.tsx:50 imports "../../rbac/state" -> modules/rbac/state',
