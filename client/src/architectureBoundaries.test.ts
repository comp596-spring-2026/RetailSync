...
const allowedCrossModuleImports = [
  'modules/accounting/components/QuickBooksTabs.tsx:4 imports "../../quickbooks/constants" -> modules/quickbooks/constants',
  ...
  'modules/quickbooks/QuickbooksDashboard.tsx:21 imports "../accounting/hooks/useQuickBooksWorkspace" -> modules/accounting/hooks/useQuickBooksWorkspace',
  'modules/quickbooks/QuickbooksRoutes.tsx:17 imports "../accounting/pages/QuickBooksLiveReadPages" -> modules/accounting/pages/QuickBooksLiveReadPages',
  'modules/quickbooks/QuickbooksRoutes.tsx:21 imports "../accounting/pages/QuickBooksMoneyPages" -> modules/accounting/pages/QuickBooksMoneyPages',
  'modules/quickbooks/QuickbooksRoutes.tsx:27 imports "../accounting/pages/QuickBooksWritePages" -> modules/accounting/pages/QuickBooksWritePages',
  ...
  'modules/quickbooks/pages/Contacts.tsx:29 imports "../../accounting/components" -> modules/accounting/components',
  'modules/quickbooks/pages/Contacts.tsx:30 imports "../../accounting/hooks/useQuickBooksWorkspace" -> modules/accounting/hooks/useQuickBooksWorkspace',
  'modules/quickbooks/pages/Contacts.tsx:37 imports "../../accounting/types/quickbooksHub" -> modules/accounting/types/quickbooksHub',
  ...
  'modules/quickbooks/pages/Money.tsx:10 imports "../../accounting/components" -> modules/accounting/components',
  'modules/quickbooks/pages/Money.tsx:11 imports "../../accounting/hooks/useQuickBooksWorkspace" -> modules/accounting/hooks/useQuickBooksWorkspace',
  ...
  'modules/quickbooks/pages/Sales.tsx:8 imports "../../accounting/components" -> modules/accounting/components',
  'modules/quickbooks/pages/Sales.tsx:9 imports "../../accounting/hooks/useQuickBooksWorkspace" -> modules/accounting/hooks/useQuickBooksWorkspace',
  ...
  'modules/quickbooks/services/quickbooks.service.ts:11 imports "../../accounting/types/quickbooksHub" -> modules/accounting/types/quickbooksHub',
