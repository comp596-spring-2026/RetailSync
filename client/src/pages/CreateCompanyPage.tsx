...
import { currencyOptions, SelectOption, timezoneOptions } from '../shared/constants/companyOptions';
...
export const CreateCompanyPage = () => {
  ...
  const onSubmit = async (values: CompanyForm) => {
    await runAction(
      ...
      dispatch(
        setAuthContext({ user: meRes.data.data.user, role: meRes.data.data.role, permissions: meRes.data.data.permissions })
      );
